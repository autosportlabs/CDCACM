...
# 				Project name
###################################################
PROJ_NAME=usbHostCDC
OUTPATH=build

###################################################
#     		the compiler definitions
###################################################
#BINPATH=/e/MyFile/mprj/PHIL_MP3/gcc-arm-none-eabi-4.7-2013q2/bin
#BINPATH=/opt/arm-2011.09/bin/
#BINPATH=/d/work/gcc-arm-4.7-2013q2/bin/
BINPATH=/opt/gcc-arm-none-eabi-4_7-2013q3/bin
